...
7. "corrected_query": Nếu người dùng viết SAI CHÍNH TẢ tên sản phẩm hoặc từ khóa, hãy sửa lại query.
   Ví dụ: "robrock f25" → "Roborock F25", "qaervo master" → "Qrevo Master", "gia f25 utra" → "giá F25 Ultra"
   Nếu không có lỗi chính tả → giữ nguyên query gốc.
